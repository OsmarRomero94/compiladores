...
int consumir;		// 1 indica al analizador lexico devolver el sgte componente lexico, 0 debe devolver el actual
char cad[5*TAMLEX];	// string para cargar mensajes de error
